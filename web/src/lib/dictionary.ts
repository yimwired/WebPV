...
const en = {
  ...
  services: {
    ...
    proof: {
      title: "This page, measured",
      sub: "Lighthouse on its throttled mobile preset, run against this site in production. These are the lowest score in each category across {routes} pages, not the best one.",
      labels: {
      ...
      measured: "Measured {date} · re-run with one command, so the number cannot quietly go stale",
    },
...
const th: typeof en = {
  ...
  services: {
    ...
    proof: {
      title: "หน้าที่คุณกำลังอ่าน วัดมาแล้ว",
      sub: "วัดด้วย Lighthouse โหมดมือถือที่จำลองเน็ตช้า รันกับเว็บตัวจริงที่ออนไลน์อยู่ ตัวเลขนี้คือคะแนนต่ำสุดของแต่ละหมวดจากทั้ง {routes} หน้า ไม่ใช่หน้าที่ได้ดีที่สุด",
      labels: {
        performance: "ความเร็ว",
        accessibility: "การเข้าถึง",
        bestPractices: "มาตรฐานเว็บ",
        seo: "SEO",
      },
      measured: "วัดเมื่อ {date} · รันซ้ำด้วยคำสั่งเดียว ตัวเลขเลยเก่าแบบเงียบๆ ไม่ได้",
    },
